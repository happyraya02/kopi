        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">SEJARAH KOPI</h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="index">Home</a></span> <span>Sejarah</span></p>
            </div>
	    ...
	    <div class="container">
	      <div class="row justify-content-center mb-5">
	        <div class="col-md-7 heading-section text-center ftco-animate">
	        	<span class="subheading">Coffee</span>
	          <h2 class="mb-4">berawal dari biji kopi</h2>
...
Dari sekian banyak jenis biji kopi yang dijual di pasaran, hanya terdapat 2 jenis varietas utama, yaitu kopi arabika (Coffea Arabica) dan robusta (Coffea Robusta). Masing-masing jenis kopi ini memiliki keunikannya masing-masing dan pasarnya sendiri.&rdquo;</p>
	              </blockquote>
	              <div class="author d-flex mt-4">
	                <div class="image mr-3 align-self-center">
	                  <img src="images/person_2.jpg" alt="">
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p><a href="#" class="btn btn-primary btn-outline-primary px-4 py-3">View</a></p>
	          </div>
    			</div>
    			<div class="col-md-6">
    				<div class="row">
