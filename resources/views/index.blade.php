...
@include('layouts.nav')
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url(assets/frontend/coffee/images/bg_1.jpg);">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">See Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
      ...
      <div class="slider-item" style="background-image: url(assets/frontend/coffee/images/bg_2.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
      ...
      <div class="slider-item" style="background-image: url(assets/frontend/coffee/images/bg_3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="gallery" class="gallery img d-flex align-items-center" style="background-image: url(assets/frontend/coffee/images/gallery-1.jpg);">
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery" class="gallery img d-flex align-items-center" style="background-image: url(assets/frontend/coffee/images/gallery-2.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery" class="gallery img d-flex align-items-center" style="background-image: url(assets/frontend/coffee/images/gallery-3.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery" class="gallery img d-flex align-items-center" style="background-image: url(assets/frontend/coffee/images/gallery-4.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
		              ...
		              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
		              	<div class="row">
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(assets/frontend/coffee/images/dish-1.jpg);"></a>
		              				<div class="text">
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(assets/frontend/coffee/images/dish-2.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Grilled Beef</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>$2.90</span></p>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(assets/frontend/coffee/images/dish-3.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Grilled Beef</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>$2.90</span></p>
	             ...
	             <blockquote>
	              ...
	              <div class="author d-flex mt-4">
	                <div class="image mr-3 align-self-center">
	                  <img src="{{asset('assets/frontend/coffee/images/person_1.jpg')}}" alt="">
	                </div>
	        ...
	        <div class="col-lg align-self-sm-end">
	          <div class="testimony overlay">
	             <blockquote>
	              ...
	              <div class="author d-flex mt-4">
	                <div class="image mr-3 align-self-center">
	                  <img src="{{asset('assets/frontend/coffee/images/person_2.jpg')}}" alt="">
	                </div>
	                <div class="name align-self-center">Louise Kelly <span class="position">Illustrator Designer</span></div>
	              </div>
	          </div>
	        ...
	        <div class="col-lg align-self-sm-end ftco-animate">
	          <div class="testimony">
	             <blockquote>
	              ...
	              <div class="author d-flex mt-4">
	                <div class="image mr-3 align-self-center">
	                  <img src="{{asset('assets/frontend/coffee/images/person_3.jpg')}}" alt="">
	                </div>
	                <div class="name align-self-center">Louise Kelly <span class="position">Illustrator Designer</span></div>
	              </div>
	          </div>
